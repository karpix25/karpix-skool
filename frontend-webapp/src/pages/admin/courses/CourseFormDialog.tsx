        ...
        <DialogContent className="max-w-md p-0 overflow-hidden rounded-2xl sm:rounded-2xl border border-border shadow-md bg-card text-foreground flex flex-col h-[min(90dvh,calc(100dvh-1rem))] sm:h-[min(85dvh,calc(100dvh-2rem))]">
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar px-6 py-8 space-y-10 pb-32">
                ...
                <div className="space-y-3">
                    ...
                    <Textarea
                        className="min-h-[120px] w-full rounded-lg border-border bg-muted/20 px-4 py-3 text-sm font-medium transition-[background-color,border-color,box-shadow] focus:ring-2 focus:ring-primary/20 resize-none leading-relaxed"
